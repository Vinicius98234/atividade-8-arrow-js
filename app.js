...
const maiúsculas = array => array.map(word => word.toUpperCase());
...
const getnumerosimpares = array => array.filter(numero => numero % 2 !==0);
...
const frase = functions.map(func => func()).join(' ');
console.log(frase)
